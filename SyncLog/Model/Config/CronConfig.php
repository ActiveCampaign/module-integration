...
namespace ActiveCampaign\SyncLog\Model\Config;
...
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/activecampaign_synclog/schedule/cron_expr';

    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/activecampaign_synclog/run/model';
