...
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/ac_newsletter_sync_cron_job/schedule/cron_expr';

    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/ac_newsletter_sync_cron_job/run/model';
